(function()
{
	...
	Sidebar.prototype.addAWS4AnalyticsPalette = function(s, w, h, w2, gn, sb, pts)
	{
		...
		[
			 ...
			 this.createVertexTemplateEntry(n2 + 'resourceIcon;resIcon=' + gn + '.opensearch_service;',
					 w2, w2, '', 'OpenSearch Service', null, null, this.getTagsForStencil(gn, 'opensearch service', dt).join(' ')),
