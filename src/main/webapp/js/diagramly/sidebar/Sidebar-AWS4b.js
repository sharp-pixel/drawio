(function()
{
	...
	Sidebar.prototype.addAWS4bAnalyticsPalette = function(w, h, w2, n, n2, gn, sb)
	{
		...
		[
			 ...
			 this.createVertexTemplateEntry(n + 'productIcon;prIcon=' + gn + '.opensearch_service;',
					 w, h + 20, 'Amazon OpenSearch Service', null, null, null, this.getTagsForStencil(gn, 'opensearch open search service', dt).join(' ')),
