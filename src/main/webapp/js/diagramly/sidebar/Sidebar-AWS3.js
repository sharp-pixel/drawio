(function()
{
	...
	Sidebar.prototype.addAWS3AnalyticsPalette = function()
	{
		...
		[
			 ...
			 this.createVertexTemplateEntry(n + 'opensearch_service;fillColor=#F58534;gradientColor=none;',
					 s * 45, s * 54, '', 'OpenSearch Service', null, null, this.getTagsForStencil(gn, 'opensearch elasticsearch elastic search service', dt).join(' ')),
